...
let hawks = Team(color: Color(red: 0.718, green: 0.165, blue: 0.263), imageName: "hawks")
...
let extraPlayers = [
    Player(id: 0, name: "Trae Young", imageName: "trae", team: hawks, age: 35, height: "6' 6\"", weight: 215),
    Player(id: 1, name: "John Collins", imageName: "john", team: hawks, age: 31, height: "6' 1\"", weight: 250),
    Player(id: 2, name: "Bogdan Bogdanovic", imageName: "bogdan", team: hawks, age: 28, height: "6' 2\"", weight: 220),
    Player(id: 3, name: "Clint Capela", imageName: "clint", team: hawks, age: 31, height: "6' 5\"", weight: 215),
    Player(id: 4, name: "De'andre Hunter", imageName: "hunter", team: hawks, age: 28, height: "6' 4\"", weight: 230)
]
